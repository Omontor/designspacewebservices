            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-categoryNews">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.news.fields.excerpt') }}
                        </th>
                        <th>
                            {{ trans('cruds.news.fields.thumb_image') }}
                        </th>
                        <th>
                            {{ trans('cruds.news.fields.banner_image') }}
                        </th>
                        <th>
                            {{ trans('cruds.news.fields.gallery') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($news as $key => $news)
                        <tr data-entry-id="{{ $news->id }}">
                            ...
                            <td>
                                @if($news->thumb_image)
                                    <a href="{{ $news->thumb_image->getUrl() }}" target="_blank" style="display: inline-block">
                                        <img src="{{ $news->thumb_image->getUrl('thumb') }}">
                                    </a>
                                @endif
                            </td>
                            <td>
                                @if($news->banner_image)
                                    <a href="{{ $news->banner_image->getUrl() }}" target="_blank" style="display: inline-block">
                                        <img src="{{ $news->banner_image->getUrl('thumb') }}">
                                    </a>
                                @endif
                            </td>
                            <td>
                                @foreach($news->gallery as $key => $media)
